...
class Fundo5401_175():
    ...
    def get_tipo_cotista_5401(self , investidor):
        ...
        try:
            tipos_de_cotista_O2 = {'NÃO CLASSIFICADO': 0, 'PESSOA FISICA NÃO RESIDENTE': 3, 'PESSOA FISICA PARAISO FISCAL': 3,
                                   'INSTITUIÇÃO FINANCEIRA': 3, 'PESSOA JURIDICA SEM FINS LUCRATIVOS': 2,
                                   ...
                                   'COOPERATIVA': 2, 'CONSORCIO': 2, 'INST. DE CARATER FILANTROPICO, RECREATIVO, CULT.': 2,
                                   'BANCO COMERCIAL/ MULTIPLO': 2, 'BANCO DE INVESTIMENTO': 2,
                                   'SOCIEDADE DE SEGURO, PREVIDENCIA E CAPITALIZAÇÃO': 2,
                                   'SOCIEDADE DTVM': 20, 'SOCIEDADE CTVM E CAMBIO': 2,
                                   'SOCIEDADE FINANCEIRA E DE CREDITO IMOBILIARIO': 2,
                                   'SOCIEDADE DE ARRENDAMENTO MERCANTIL (LEASING)': 2,
    ...
    def criar_fundo(self, cnpj_fundo, quantidade_cotas, quantidade_cotistas, plFundo):
        fundo = ET.Element("classe")
        
        fundo.set("idClasse", cnpj_fundo)
    ...
    def job_criar_cotista_unico(self , cotista , n_posicao ,  xml_cotistas ):
        ...
        try:
            ...
            cotas_df_pre_ajustado = cotas_df.group_by(["fundo", "valor_cota", "cotatipo" , "subclasse"]).agg(
                [
            ...
            for record in cotas_records:
                ...
                for key, value in record.items():
                    if key in ['subclasse' ,  'tipoCota', 'qtdeCotas', 'valorCota' ]: 
    ...
    def transforma_posicao_posicao_informe(self):
        ...
        df_posicao = self.consultar_posicoes_jcot()[[ 'cd_cotista' , 'cpfcnpjCotista', 'fundo', 'valor_cota' , 'cotatipo' , 'vlCorrigido' , 'qtCotas' ,  "tipoCotista" , "subclasse"]]
